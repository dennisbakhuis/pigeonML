...
def annotate(examples,
    ...
    def show_next():
        ...
        current_index += 1
        if example_process_fn is not None and current_index > 0 and current_index <= len(examples):
            example_process_fn(current_index - 1, annotations.get(examples[current_index - 1]))
    ...
    def add_annotation(annotation):
        annotations[examples[current_index]] = annotations
        show_next()
